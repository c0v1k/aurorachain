...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " aurora-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  aurora-tx [options] <hex-tx> [commands]  Update hex-encoded aurora transaction\n" +
            "or:     aurora-tx [options] -create [commands]   Create hex-encoded aurora transaction\n" +
            "\n";
